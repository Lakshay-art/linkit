...
const addlink=(props)=>{
    const map=new Map([
        ...
        ["poda","linear-gradient(45deg,transparent 6%,red 6%,rgb(255,0,0) 94%,transparent 94%)"],
        ["podi","linear-gradient(45deg,transparent 6%,red 6%,rgb(255,0,0) 94%,transparent 94%)"]
    ]);
